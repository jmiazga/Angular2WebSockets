...
var JitProtoChangeDetector = (function () {
    ...
    JitProtoChangeDetector.prototype._createFactory = function (definition) {
        ...
        return new change_detection_jit_generator_1.ChangeDetectorJITGenerator(definition.id, definition.strategy, propertyBindingRecords, eventBindingRecords, this.definition.directiveRecords, this.definition.generateCheckNoChanges)
            .generate();
    };
